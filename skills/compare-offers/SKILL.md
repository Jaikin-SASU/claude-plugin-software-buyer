...
argument-hint: "<paths to two or more quotes>"
---
...
4. **Risk score** per offer using the review-quote checklist (price cap, ownership, acceptance, exit, reversibility, data). A bounded-risk offer can beat a lower price.
